...
function wp_dashboard_primary() {
	$feeds = array(
		'news' => array(
			 ...
			 */
			'link' => apply_filters( 'dashboard_primary_link', __( 'http://www.jackieathome.net' ) ),
			 ...
			 */
			'url' => apply_filters( 'dashboard_primary_feed', __( 'http://www.jackieathome.net/feed/' ) ),
			 ...
			 */
			'title'        => apply_filters( 'dashboard_primary_title', __( 'WordPress SAE - Jackie\' Blog' ) ),
			'items'        => 1,
			'show_summary' => 0,
			'show_author'  => 0,
			'show_date'    => 0,
